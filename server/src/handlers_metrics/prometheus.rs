...
# HELP aionbd_l2_index_build_max_in_flight Configured maximum concurrent asynchronous L2 index builds.\n\
# TYPE aionbd_l2_index_build_max_in_flight gauge\n\
...
aionbd_max_points_per_collection {}\n",
        ...
        metrics.l2_index_build_max_in_flight,
